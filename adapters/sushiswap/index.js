...
module.exports = {
    masterChefV1: async (
        ...
        const totalSupply = toFloat(await ethereum.erc20(provider, contractAddress).balanceOf(masterChiefV1Address), stakingTokenDecimals);
        const {
            token0,
            reserve0,
            token1,
        ...
        const tvl = new bn(totalSupply).multipliedBy(stakingTokenUSD);
