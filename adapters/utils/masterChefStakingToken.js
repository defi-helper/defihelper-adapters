...
class PairStakingToken extends StakingToken {
    ...
    async init() {
        const {
            ...
            reserve1,
            totalSupply,
        } = await ethereum.uniswap.pairInfo(this.provider, this.token);
    ...
    static async create(
        ...
        const instance = new PairStakingToken(
            provider,
            token,
            network,
            blockTag,
...
class ErcStakingToken extends StakingToken {
    ...
    static async create(
        ...
        const instance = new ErcStakingToken(
            provider,
            token,
            network,
            blockTag,
...
module.exports = {
     ...
     */
    getMasterChefStakingToken: async (
        provider,
        token,
        network,
        blockTag,
        ...
        try {
            return await PairStakingToken.create(
                provider,
                token,
                network,
                blockTag,
